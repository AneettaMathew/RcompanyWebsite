                ...
                <div class="row border-primary rounded mx-0 p-3">
                    <div class="col-12">
                        <div class="row" id="editprofile" style="display: flex;">
                            <div class="col-12">
                                <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Add Testimonial</strong>
                                <form action="{{route('testimonialadd')}}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                  <div class="col-md-7 mb-2">
                                        <label for="">Client Name</label>
                                        <input style="width: 560px; height: 50px;" name ="clientname"type="text" class="form-control" value ="">
                                    </div>
                                    <div class="col-md-7 mb-2">
                                        <label for="">Company Name</label>
                                        <input style="width: 560px; height: 50px;" name ="companyname"type="text" class="form-control" value ="">
                                    </div>
                                    <div class="col-md-7 mb-2">
                                        <label for="">Position </label>
                                        <input style="width: 560px; height: 50px;" name ="postision"type="text" class="form-control" value ="">
                                    </div>

                                    <div class="col-md-9 mb-2">
                                        <label for=""> Description</label>
                                        <textarea style="width: 560px; height: 150px;" name="description" value="" type="text" class="form-control"></textarea> 
                                    </div>
                                    ...
                                    <div class="col-12 d-flex">
                                        <button type="submit" class="btn btn-primary btn-typ4">Add Testimonial</button>
