                ...
                <div class="row border-primary rounded mx-0 p-3">
                    <div class="col-12">
                        <div class="row" id="editprofile" style="display: flex;">
                            <div class="col-12">
                                <strong class="fs-16 fw-500 light-blue-txt mb-3 d-block">Add Services</strong>
                                <form action="{{route('servicesadd')}}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                  <div class="col-md-7 mb-2">
                                        <label for="">Service</label>
                                        <input style="width: 560px; height: 50px;" name ="title"type="text" class="form-control" value ="">
                                    </div>
                                    ...
                                    <div class="col-12 d-flex">
                                        <button type="submit" class="btn btn-primary btn-typ4">Add Service</button>
