...
<section class="work-section pt-5 mt-xxl-5 mt-xl-4 mb-5">
    ...
    <section class="get-in-touch-section mt-md-5 mt-4 pt-xxl-4 pt-lg-3">
        <div class="container">
            <div class="row mb-4">
                <div class="col-lg-6 mb-5">
                    <form class="row justify-content-between me-lg-4" method="post" action="{{route('store.message')}}">
                        @csrf
                        ...
                        <span style="color: lightblue">@error('message'){{$message}}@enderror</span>
                            <textarea type="text" name="message" class="w-100" rows="5" placeholder="Message"></textarea>
                        </div>
                        <div class="col-12">
                ...
                <div class="col-lg-6">
                    <div class="d-flex flex-column pt-3 ms-lg-5 ps-lg-5">
                        <!-- <div class="hd-typ4 fw-400 fs-25-xl fs-23-lg fs-18-m mb-3">
                            Say something, we'd love to chat.
                        </div>
        ...
        <div class="location-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15718.548384046218!2d76.290172!3d9.964121!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf0f993910b89e1d7!2sReubro%20International!5e0!3m2!1sen!2sin!4v1675403694675!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
